...
/**
 * The SaveSimulationDescription class provides a dialog for users to enter metadata about a
 * simulation before saving it. Users can specify a title, author, and description.
 *
...
public class SaveSimulationDescription {
  ...
  /**
   * A record that stores metadata about a simulation, including title, author, description, and
   * save location.
   */
  public record SimulationMetadata(String title, String author, String description,
                                   File saveLocation) {
  ...
  private void setupDialog() {
    ...
    // Add buttons
    ButtonType saveButtonType = new ButtonType(myResources.getString("Save"),
   ...
   *
   * @return A SimulationMetadata object containing user-entered data and file location, or null if
   * canceled.
   */

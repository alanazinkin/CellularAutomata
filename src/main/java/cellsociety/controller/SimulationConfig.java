...
/**
 * Represents the configuration for a simulation, including metadata, grid dimensions, initial
 * states, and simulation parameters.
 *
...
public class SimulationConfig {
   ...
   * @param title         title full name of the simulation (ex: Spreading Fire, Game of Life,
   *                      etc.)

...
/**
 * Interface that allows grids to dynamically resize for infinite edge support. This is needed for
 * the InfiniteEdge strategy to work properly.
 *
...
public interface DynamicGrid {
  ...
  /**
   * Expands the grid to include the specified range of coordinates. Implementation should handle
   * creating new cells with appropriate states.
   *

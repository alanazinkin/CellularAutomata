...
public class TriangleGridView extends GridView {
  ...
  public TriangleGridView(SimulationController simulationController,
    ...
    setCellWidth(parseInt(myConfigResourceMap.getOrDefault("grid.width", "400"))
        / numCols);
    setCellHeight(parseInt(myConfigResourceMap.getOrDefault("grid.height", "400"))
        / numRows);
  ...
  private void addColumnConstraints() {
    for (int i = 0; i < numCols; i++) {
      myGridPane.getColumnConstraints()
